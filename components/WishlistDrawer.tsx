    ...
    >
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <motion.div
          ...
          className="w-screen max-w-md bg-paper-light border-l border-sand/40 shadow-2xl flex flex-col justify-between text-charcoal"
        >
          {/* Header */}
          <div className="p-6 border-b border-sand/30 flex items-center justify-between bg-paper">
            ...
            <button
              ...
              className="p-2 rounded-full bg-sand/15 hover:bg-sand/30 text-charcoal transition-colors cursor-pointer border border-sand/40"
            ...
            {items.length === 0 ? (
              ...
              items.map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="p-4 rounded-2xl bg-paper border border-sand/30 space-y-3.5 hover:border-gold/50 transition-colors shadow-sm"
                  >
                    <div className="flex space-x-3.5">
                      <Link
                        ...
                        className="relative w-20 h-26 rounded-xl overflow-hidden bg-paper-dark flex-shrink-0 border border-sand/30 group"
                      >
                        <img
                          src={product.image}
                          alt={product.name}
                        ...
                        <div className="space-y-1">
                          <div className="flex items-start justify-between gap-2">
                            <Link
                              ...
                              className="font-serif text-base text-charcoal font-medium truncate hover:text-gold transition-colors"
                            >
                              {product.name}
                            </Link>
                            <button
                          ...
                          <p className="font-serif text-sm font-semibold text-charcoal pt-0.5">
