...
export default function BrandLogo({
  ...
  const sizeStyles = {
    sm: {
      ...
      sub: "text-[7.5px] sm:text-[8px] tracking-[0.40em] -mt-1 pl-[0.1em]",
    },
    md: {
      // Standard navbar size
      brand: "text-[24px] sm:text-[27px] lg:text-[29px]",
      sub: "text-[8.5px] sm:text-[9.5px] lg:text-[10px] tracking-[0.42em] -mt-1 pl-[0.15em]",
    },
    lg: {
      // Footer size
      brand: "text-[32px] sm:text-[38px] lg:text-[42px]",
      sub: "text-[11px] sm:text-[12.5px] lg:text-[13.5px] tracking-[0.43em] -mt-1.5 pl-[0.18em]",
    },
    xl: {
      brand: "text-[46px] sm:text-[56px] lg:text-[64px]",
      sub: "text-[14px] sm:text-[17px] lg:text-[19px] tracking-[0.44em] -mt-2 pl-[0.2em]",
    },
    hero: {
      // Splash screen / giant editorial size
      brand: "text-[64px] sm:text-[80px] md:text-[96px] lg:text-[110px]",
      sub: "text-[18px] sm:text-[22px] md:text-[26px] lg:text-[30px] tracking-[0.45em] -mt-3 sm:-mt-4 pl-[0.2em]",
    },
  }[size];
