          ...
          {STORIES.map((story) => {
            ...
            return (
              <button
                ...
                className={`group px-4 sm:px-5 py-2.5 rounded-full text-sm font-sans uppercase font-semibold tracking-[0.2em] transition-all duration-300 border cursor-pointer select-none flex items-center gap-2 ${
                  isActive
            ...
            >
              ...
              <div className="lg:col-span-5 relative aspect-[3/4] rounded-2xl overflow-hidden bg-paper-dark border border-sand/40 shadow-lg">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  ...
                  <p className="text-sm font-sans text-sand/80 font-light flex items-center gap-1 mt-1">
              ...
              <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 text-sm font-sans uppercase font-semibold tracking-[0.3em] text-gold font-semibold">
                    ...
                    <span className="font-mono text-charcoal-subtle">{activeStory.coordinates}</span>
                  </div>
                  ...
                  <blockquote className="font-serif text-lg sm:text-xl text-charcoal font-light border-l-2 border-gold/70 pl-4 py-1 leading-relaxed">
                ...
                <div className="space-y-2 pt-2 border-t border-sand/30">
                  <span className="text-sm font-sans uppercase font-semibold tracking-wider text-charcoal-subtle font-semibold block">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {activeStory.elements.map((el, i) => (
                      <span
                        key={i}
                        className="text-sm font-sans px-3 py-1 rounded-full bg-gold/10 text-charcoal border border-gold/25 font-light"
                      >
                        {el}
                      </span>
                    ))}
                ...
                <div className="pt-4 border-t border-sand/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  ...
                  <Link
                    href="/stories"
                    className="text-sm font-sans uppercase font-semibold tracking-[0.2em] text-charcoal/80 hover:text-gold transition-colors font-medium"
                  >
                    View All 5 Chapters →
                  </Link>
                </div>
